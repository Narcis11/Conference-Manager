...
public class DoctorSignUpActivity extends AppCompatActivity {
    ...
    private final String LOG_TAG = DoctorSignUpActivity.class.getSimpleName();
    ...
    private void loadUIElements() {
        mInputFieldsLayout = (RelativeLayout) findViewById(R.id.doctor_signup_fields_layout);
        //the edittext views
        mUsernameEditText = (EditText) mInputFieldsLayout.findViewById(R.id.doctor_signup_username_value);
        mPasswordEditText = (EditText) mInputFieldsLayout.findViewById(R.id.doctor_signup_password_value);
        mConfirmPasswordEditText = (EditText) mInputFieldsLayout.findViewById(R.id.doctor_signup_confirm_password_value);
        mEmailEditText = (EditText) mInputFieldsLayout.findViewById(R.id.doctor_signup_email_value);
        //the error textviews
        mUsernameError = (TextView) mInputFieldsLayout.findViewById(R.id.doctor_signup_username_error);
        mPasswordError = (TextView) mInputFieldsLayout.findViewById(R.id.doctor_signup_password_error);
        mConfirmPasswordError = (TextView) mInputFieldsLayout.findViewById(R.id.doctor_signup_confirm_password_error);
        mEmailError = (TextView) mInputFieldsLayout.findViewById(R.id.doctor_signup_email_error);
        //the sign up button
        mSignUpButton = (Button) findViewById(R.id.doctor_signup_button);
    }
    ...
    private class CheckUsernameAvailability extends AsyncTask<String, Void, Cursor> {
        ...
        protected void onPostExecute(Cursor cursor) {
            ...
            if (cursorCount == 0) {
                ...
                userValues.put(UsersContract.UsersEntry.COLUMN_USER_TYPE, Constants.DOCTOR_USER_TYPE);
    ...
    class SaveUsernameAsync extends AsyncTask<Vector<ContentValues>, Void, Integer> {
        ...
        protected void onPostExecute(Integer rowsInserted) {
            ...
            if (rowsInserted == 1) {
                ...
                Intent mainActivityIntent = new Intent(DoctorSignUpActivity.this, DoctorMainActivity.class);
