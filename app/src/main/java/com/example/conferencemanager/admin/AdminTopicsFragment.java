...
/**
 Used to display the available topics
 */
public class AdminTopicsFragment extends Fragment implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public AdminTopicsFragment() {
        // Required empty public constructor
    }

    public static AdminTopicsFragment newInstance() {
        AdminTopicsFragment fragment = new AdminTopicsFragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTopicsAdapter = new SimpleCursorAdapter(
                getActivity(),
                R.layout.admin_fragment_topics_row,
                null,
                new String[] {
                        UsersContract.TopicsEntry.COLUMN_TOPIC_TITLE,
                        UsersContract.TopicsEntry.COLUMN_TOPIC_DESCRIPTION
                ...
                new int[] {
                        R.id.admin_fragment_topic_title_row,
                        R.id.admin_fragment_topic_description_row
                },
                0
        );
        // Inflate the layout for this fragment
        mRootView = inflater.inflate(R.layout.admin_fragment_topics, container, false);
        mListView = (ListView) mRootView.findViewById(R.id.admin_topics_listview);
        mNoTopicsTextView = (TextView) mRootView.findViewById(R.id.admin_topics_no_rows);
